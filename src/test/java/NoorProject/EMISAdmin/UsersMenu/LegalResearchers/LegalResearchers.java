/*
 * Created By Rami AlShawabkeh 4/1/18 5:18 PM
 */

package NoorProject.EMISAdmin.UsersMenu.LegalResearchers;
...
public class LegalResearchers {
        ...
        public void ADDGeneralDirectorOfSchoolSecurityAndSafetyUser() throws InterruptedException {
            ...
            WebElement ReportLinkLocatorWait = waitQA.until(ExpectedConditions.visibilityOfElementLocated(UserNameLocater));
