...
public class UserDataInTheSchools {
    ...
    private By TheReportLoactor = By.linkText("بيانات المستخدمين بالمدارس");
    ...
    private By btn_search_Locator = By.xpath("//*[@id=\"ctl00_PlaceHolderMain_ibtnSearch\"]");
...
//بيانات المستخدمين بالمدارس
    ...
    public void UserDataInTheSchoolsReports() throws InterruptedException {
        ...
        WebElement TheReportLoactorWait = waitQA.until(ExpectedConditions.visibilityOfElementLocated(TheReportLoactor));
