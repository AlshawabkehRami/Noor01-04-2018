/*
 * Created By Rami Alshawabkeh  3/14/18 3:41 PM
 */
...
public class GeneralDirectorOfSchoolSecurityAndSafetyOfficer {
    //أضافة
//موظفو صلاحيات مدير عام الأمن والسلامة المدرسية
    ...
    public void ADDGeneralDirectorOfSchoolSecurityAndSafetyOfficer() throws InterruptedException {
        ...
        MyInputLocatorWait.sendKeys("صلاحيات مدير عام الأمن والسلامة المدرسية");
